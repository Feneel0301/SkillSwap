...
export const SkillSwapLogo = ({ className }) => (
  ...
  >
    <path
      ...
      fill="#1d4ed8" /* Adjusted primary blue color */
    />
    <path
      d="M8.5 12.5v-3H10l-2.5-3-2.5 3h1.5v3h2zM15.5 11.5v3H14l2.5 3 2.5-3h-1.5v-3h-2z"
      fill="#ffffff"
    />
  </svg>
);
...
export const CreditsIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const TranslateIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M21 15v4a2 2 0 0 1-2 2H5l-3 3V5a2 2 0 0 1 2-2h4"></path>
    <path d="M11 7h7a2 2 0 0 1 2 2v7"></path>
    <path d="M11 11h5"></path>
    <path d="M11 15h3"></path>
  </svg>
);
